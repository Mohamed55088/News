                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="trending-top mb-30">
                                <div class="trend-top-img">
                                    <img src="{{ asset('build/assets/en/assets/img/trending/trending_top.jpg') }}"
                                        alt="">
                            ...
                            <div class="trending-bottom">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="single-bottom mb-35">
                                            <div class="trend-bottom-img mb-30">
                                                <img src="{{ asset('build/assets/en/assets/img/trending/trending_bottom1.jpg') }}"
                                                    alt="">
                                            </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="single-bottom mb-35">
                                            <div class="trend-bottom-img mb-30">
                                                <img src="{{ asset('build/assets/en/assets/img/trending/trending_bottom2.jpg') }}"
                                                    alt="">
                                            </div>
                                            <div class="trend-bottom-cap">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="single-bottom mb-35">
                                            <div class="trend-bottom-img mb-30">
                                                <img src="{{ asset('build/assets/en/assets/img/trending/trending_bottom3.jpg') }}"
                                                    alt="">
                                            </div>
                                            <div class="trend-bottom-cap">
                        ...
                        <div class="col-lg-4">
                            <div class="trand-right-single d-flex">
                                <div class="trand-right-img">
                                    <img src="{{ asset('build/assets/en/assets/img/trending/right1.jpg') }}" alt="">
                                </div>
                            ...
                            <div class="trand-right-single d-flex">
                                <div class="trand-right-img">
                                    <img src="{{ asset('build/assets/en/assets/img/trending/right2.jpg') }}" alt="">
                                </div>
                                <div class="trand-right-cap">
                            ...
                            <div class="trand-right-single d-flex">
                                <div class="trand-right-img">
                                    <img src="{{ asset('build/assets/en/assets/img/trending/right3.jpg') }}" alt="">
                                </div>
                                <div class="trand-right-cap">
                            ...
                            <div class="trand-right-single d-flex">
                                <div class="trand-right-img">
                                    <img src="{{ asset('build/assets/en/assets/img/trending/right4.jpg') }}" alt="">
                                </div>
                                <div class="trand-right-cap">
                            ...
                            <div class="trand-right-single d-flex">
                                <div class="trand-right-img">
                                    <img src="{{ asset('build/assets/en/assets/img/trending/right5.jpg') }}" alt="">
                                </div>
                                <div class="trand-right-cap">
                ...
                <div class="trending-main">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="trand-right-single d-flex">
                                <div class="trand-right-img">
                                    <img src="{{ asset('build/assets/en/assets/img/trending/right1.jpg') }}"
                                        alt="">
                                </div>
                                <div class="trand-right-cap">
                                    <span class="color1">Concert</span>
                            ...
                            <div class="trand-right-single d-flex">
                                <div class="trand-right-img">
                                    <img src="{{ asset('build/assets/en/assets/img/trending/right2.jpg') }}"
                                        alt="">
                                </div>
                                <div class="trand-right-cap">
                                    <span class="color3">sea beach</span>
                            ...
                            <div class="trand-right-single d-flex">
                                <div class="trand-right-img">
                                    <img src="{{ asset('build/assets/en/assets/img/trending/right3.jpg') }}"
                                        alt="">
                                </div>
                                <div class="trand-right-cap">
                                    <span class="color2">Bike Show</span>
                            ...
                            <div class="trand-right-single d-flex">
                                <div class="trand-right-img">
                                    <img src="{{ asset('build/assets/en/assets/img/trending/right4.jpg') }}"
                                        alt="">
                                </div>
                                <div class="trand-right-cap">
                                    <span class="color4">See beach</span>
                            ...
                            <div class="trand-right-single d-flex">
                                <div class="trand-right-img">
                                    <img src="{{ asset('build/assets/en/assets/img/trending/right5.jpg') }}"
                                        alt="">
                                </div>
                                <div class="trand-right-cap">
                                    <span class="color1">Skeping</span>
                            ...
                            <div class="weekly-news-active dot-style d-flex dot-style">
                                <div class="weekly-single">
                                    <div class="weekly-img">
                                        <img src="{{ asset('build/assets/en/assets/img/news/weeklyNews2.jpg') }}"
                                            alt="">
                                    </div>
                                ...
                                <div class="weekly-single active">
                                    <div class="weekly-img">
                                        <img src="{{ asset('build/assets/en/assets/img/news/weeklyNews1.jpg') }}"
                                            alt="">
                                    </div>
                                    <div class="weekly-caption">
                                        <span class="color1">Strike</span>
                                ...
                                <div class="weekly-single">
                                    <div class="weekly-img">
                                        <img src="{{ asset('build/assets/en/assets/img/news/weeklyNews3.jpg') }}"
                                            alt="">
                                    </div>
                                    <div class="weekly-caption">
                                        <span class="color1">Strike</span>
                            ...
                            <div class="video-caption">
                                ...
                                <div class="bottom-caption">
                                    ...
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod ipsum dolor
                                        sit.
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod ipsum dolor
                                        sit.
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod ipsum dolor
                                        sit
